<template>
    <header>
        ...
        <div class="welcome">
            Hello, I'm
            <span class="gradientText">xiaojie</span>
        </div>
        ...
        <div class="iconContainer">
            <a class="iconItem" data-tip="Github" target="_blank" href="https://github.com/jiege6919">
                <svg t="1704870335945" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="2487" width="22px" height="22px">
                    <path
            ...
            <a class="iconItem" data-tip="Mail" target="_blank" href="mailto:ok@yangjie.site">
                <svg t="1704870588438" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="3174" width="22px" height="22px">
                    <path
            ...
            <a class="iconItem" data-tip="捐赠" onclick="wx('wxpay.png')" href="javascript:void(0)">
                <svg t="1705247464964" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="4987" width="22px" height="22px">
                    <path
            ...
            <a class="iconItem" data-tip="B站" target="_blank" href="https://space.bilibili.com/646325099">
                <svg t="1704900728948" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="28587" width="22px" height="22px">
                    <path
